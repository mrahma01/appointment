...
urlpatterns = patterns('',
    ...
    url(r'^update/(?P<key>\w{11})/$', views.AppointmentUpdateView.as_view(), name='update-appointment'),
    url(r'^delete/(?P<key>\w{11})/$', views.AppointmentDeleteView.as_view(), name='delete-appointment'),
)
